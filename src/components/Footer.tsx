  ...
  return (
    <footer className="bg-gradient-to-b from-cream-100 to-cream-200/90 border-t border-cream-300 text-sacred-800 pt-12 pb-24 sm:pb-8 mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Main Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-10 border-b border-cream-300/80">
          ...
          {/* Devotional Categories & Quick Links */}
          <div className="space-y-6">
            <div>
              <h4 className="text-sm font-bold uppercase tracking-wider text-maroon-800 mb-3 font-devanagari flex items-center gap-1.5">
          ...
          {/* Organization & Devotional Purpose */}
          <div className="space-y-3">
            <h4 className="text-sm font-bold uppercase tracking-wider text-maroon-800 font-devanagari">
              {t('devotionalPurpose')}
            </h4>
            <p className="text-xs sm:text-sm text-sacred-600 leading-relaxed">
              {language === 'hi'
                ? 'यह वेबसाइट नव ज्योति दुर्गा मंडल के भक्ति साहित्य, भजन, आरती व चालीसा के पठन एवं साधना हेतु समर्पित है। समस्त पाठ प्रामाणिक व पारंपरिक स्वरूप में सुरक्षित हैं।'
                : 'Dedicated to the devotional literature, bhajans, aartis, and chalisas of Nav Jyoti Durga Mandal for spiritual reading, worship, and preservation.'
              }
            </p>
          </div>
        </div>
